...
VOC2007_CHANNEL_ID=`abeja datalake create-channel --name "VOC-2007" --description "PascalVOC2007 data" | jq -r '.channel.channel_id'`
VOC2012_CHANNEL_ID=`abeja datalake create-channel --name "VOC-2012" --description "PascalVOC2012 data" | jq -r '.channel.channel_id'`
